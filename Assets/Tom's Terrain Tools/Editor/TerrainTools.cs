...
public class TerrainTools : EditorWindow {
	...
	void ApplyOverlaymap() {
		...
		float terrainScale = (float)w / ((float)terrain.heightmapResolution-1);
...
//		Debug.Log("reading heightmap "+path+" / size = "+size);
		...
		int heightmapWidth = MyTerrain.terrainData.heightmapResolution;
		int heightmapHeight = MyTerrain.terrainData.heightmapResolution;
